...
tf_norm_path = '../data/course_info_scores/course_info_tf_norm.csv'
df_path = '../data/course_info_scores/course_info_df.csv'
idf_path = '../data/course_info_scores/course_info_idf.csv'
tfidf_path = '../data/course_info_scores/course_info_tfidf.csv'
