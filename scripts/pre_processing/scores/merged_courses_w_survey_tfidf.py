...
output_file = '../../../data/bm25/bm25/merged_courses_w_survey_tfidf.csv'
...
with open('../../../data/survey_processing/merged_survey.json') as f:
...
tf_vect.to_csv('../../../data/bm25/bm25/merged_courses_w_survey_tf.csv')
tf_vect_norm.to_csv('../../../data/bm25/bm25/merged_courses_w_survey_tf_norm.csv')
...
idf_vect.to_csv('../../../data/bm25/bm25/merged_courses_w_survey_idf.csv')
